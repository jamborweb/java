...
<div class="container container-main">
    <div class="row row-logowanie text-center">Dodawanie trenera</div>
    <div class="row row-form">
    <?php
       
   
        echo "<form action='dodaj_trenera_form.php' method='post'>";
                    echo "<table>";
                    ...
                    echo "</table>";
                    echo "<br>";
                    echo "<tr><td><button name='dodajtrenerabutton' class='btn btn-info'>Dodaj trenera</button></td></tr>
