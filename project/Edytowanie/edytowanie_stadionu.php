...
<?php
    ...
    $getStadions = "SELECT * FROM stadiony WHERE id_stadiony=$stadionId";
...
<div class="container container-main">
    ...
    <?php
        ...
        echo "<form action='edytuj_stadion_form.php' method='post'>";
                    echo "<input type='hidden' name='idStadionedit' value='".$stadionId."'>";
                    echo "<table>";
                    echo "<tr><td>Nazwa stadionu: </td><td><textarea name='stadionNameedit' required>".$stadionName."</textarea></td></tr>";
                    echo "<tr><td>Pojemność stadionu: </td><td><textarea name='stadionCapacityedit' required>". $stadionCapacity ."</textarea></td></tr>";
                    echo "<tr><td>Klub: </td><td><select name='editStadionId'>";
