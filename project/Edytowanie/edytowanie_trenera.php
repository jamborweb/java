...
<?php
    ...
    $getCoach = "SELECT * FROM trenerzy WHERE id_trenerzy=$coachId";
...
<div class="container container-main">
    ...
    <?php
        ...
        echo "<form action='edytuj_trenera_form.php' method='post'>";
                    echo "<input type='hidden' name='idCoachedit' value='".$coachId."'>";
                    echo "<table>";
                    echo "<tr><td>Imie trenera: </td><td><textarea name='coachFirstNameedit' required>".$coachFirstName."</textarea></td></tr>";
                    echo "<tr><td>Nazwisko trenera: </td><td><textarea name='coachLastNameedit' required>". $coachLastName ."</textarea></td></tr>";
                    echo "</table>";
                    echo "<br>";
