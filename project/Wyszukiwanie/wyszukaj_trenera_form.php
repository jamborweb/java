...
<?php
    ...
    $getCoach = "SELECT * FROM trenerzy 
    WHERE trener_imie LIKE '$coachFirstName%' 
    AND trener_nazwisko LIKE '$coachLastName%'";
...
<div class="container container-main">
    ...
    <div class="row">
         <a href='../admintrenerzy.php' class='btn btn-success btn-wstecz' role='button'>Wstecz</a>
